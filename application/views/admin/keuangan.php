        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <hr>
                    <table>
                        <a href="<?= base_url('admin/tambahkeuangan/'); ?>">
                            ...
                            foreach ($admin as $admin) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('admin/updatekeuangan/' . $admin->id_keuangan); ?>">Ubah</a>
                                        <hr>
                                        <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                                        <a href="<?= base_url('admin/hapuskeuangan/' . $admin->id_keuangan); ?>">Hapus</a>
                                    </td>
                                </tr>
