                            ...
                            foreach ($admin as $adm) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('superadmin/editpengajuan/' . $adm->id_pengajuan); ?>">Ubah</a>
                                        <hr>
                                        <i class="fas fa-edit bg-success p-2 text-white rounded"></i>
                                        <a href="<?= base_url('superadmin/statuspengajuan/' . $adm->id_pengajuan); ?>">Status</a>
                                        <hr>
                                        <i class="fas fa-edit bg-success p-2 text-white rounded"></i>
                                        <a href="<?= base_url('superadmin/terimapengajuan/' . $adm->id_pengajuan); ?>">Terima</a>
                                        <hr>
                                        <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                                        <a href="<?= base_url('superadmin/tolakpengajuan/' . $adm->id_pengajuan); ?>">Hapus</a>
                                    </td>
                                </tr>
